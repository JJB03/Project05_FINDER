...
VALUES 
    (22, '소프트웨어 엔지니어 포지션', '우리는 Java 및 Spring Boot 경험이 있는 소프트웨어 엔지니어를 찾고 있습니다.', '소프트웨어 응용 프로그램을 개발하고 유지 관리합니다.', '컴퓨터 과학 또는 관련 분야의 학사 학위.', 'RESTful API 및 마이크로서비스 아키텍처 경험.', '2024-06-03'),
    (23, '데이터 과학자 포지션', '우리 팀에 합류할 데이터 과학자를 찾고 있습니다.', '복잡한 데이터 세트를 분석하고 해석합니다.', '데이터 과학 또는 관련 분야의 석사 학위.', '머신러닝 알고리즘 경험.', '2024-06-03'),
    (24, '웹 개발자 모집', '저희 회사에서는 웹 개발자를 모집합니다. HTML, CSS 및 JavaScript에 능숙한 분을 찾고 있습니다.', '웹 사이트 및 웹 애플리케이션 개발', '웹 개발 관련 학위 또는 자격증', '프론트엔드 및 백엔드 프레임워크 경험', '2024-06-03'),
    (25, '데이터베이스 관리자 모집', '데이터베이스 관리자를 채용합니다. SQL 쿼리 및 데이터베이스 성능 최적화에 능숙한 분을 찾습니다.', '데이터베이스 설치, 구성 및 유지 관리', '컴퓨터 과학 또는 관련 분야의 학사 학위', '관계형 및 NoSQL 데이터베이스 관리 경험', '2024-06-03'),
    (26, '프로젝트 매니저 채용', '프로젝트 매니저를 모집합니다. 프로젝트 일정 및 예산 관리에 능숙한 분을 찾습니다.', '프로젝트 팀 관리 및 리소스 할당', '프로젝트 관리 관련 자격증', '소프트웨어 개발 및 배포 프로세스 이해', '2024-06-03'),
    (27, 'UI/UX 디자이너 채용', 'UI/UX 디자이너를 모집합니다. 사용자 경험에 초점을 둔 디자인을 만들 수 있는 분을 찾습니다.', '웹 및 모바일 애플리케이션 디자인', 'UI/UX 디자인 관련 학위 또는 자격증', 'Adobe Creative Suite 및 Sketch 등의 디자인 도구 경험', '2024-06-03'),
    (28, '시스템 엔지니어 채용', '시스템 엔지니어를 모집합니다. 서버 및 네트워크 인프라를 구성하고 유지 관리할 수 있는 분을 찾습니다.', '시스템 아키텍처 설계 및 구현', '컴퓨터 과학 또는 관련 분야의 학사 학위', '클라우드 플랫폼 및 가상화 기술 경험', '2024-06-03'),
    (29, '보안 엔지니어 채용', '보안 엔지니어를 모집합니다. 정보 보안 시스템을 설계하고 구현할 수 있는 분을 찾습니다.', '네트워크 보안 및 데이터 보호', '정보 보안 관련 자격증', 'SIEM 및 IDS/IPS 시스템 관리 경험', '2024-06-03'),
    (30, 'QA 엔지니어 채용', '품질 보증 엔지니어를 모집합니다. 제품 및 서비스의 품질을 확인하는 역할을 수행할 수 있는 분을 찾습니다.', '소프트웨어 테스트 계획 및 실행', '소프트웨어 테스팅 관련 자격증', '자동화 테스트 도구 사용 경험', '2024-06-03'),
    (31, '데이터 엔지니어 채용', '데이터 엔지니어를 모집합니다. 대규모 데이터 처리 및 분석 시스템을 구축할 수 있는 분을 찾습니다.', '데이터 파이프라인 설계 및 구현', '데이터 엔지니어링 또는 관련 분야의 학사 학위', '빅데이터 및 데이터베이스 기술 경험', '2024-06-03');
